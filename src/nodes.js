...
export const DEF = [
  ...
  [0, 0, 1.02, 0.32, 1, 40, 1, 1, F.PRISM, 0, 6, 'PRISM', 'NEAR FILL', 0, 3],
  [1, 1, 0.30, 0.42, 1, 15, 1, 1, F.SHOCK, 0, 6, 'SHOCK', 'BLAST WAVE', 0, 1],
  [1, 1, 0.55, 0.16, 5, 8, 1.55, 0, S.SWF, 0.05, 1, 'FILL', '+WAVE', 4, 1],
  [1, 1, 0.78, 0.40, 5, 8, 1.55, 0, S.SWR, 0.2, 1, 'RADIUS', '+SIZE', 4, 1],
  [1, 1, 1.02, 0.14, 3, 12, 1.7, 0, S.SWS, 0.15, 1, 'BLAST', '+WAVE', 4, 1],
  [2, 2, 0.30, 0.10, 5, 8, 1.55, 0, S.GLD, 0.12, 2, 'GOLD', '+GOLD'],
  [2, 2, 0.55, 0.36, 3, 12, 1.7, 0, S.CGD, 0.18, 2, 'COMBO', '+COMBO $', 8, 1],
  [2, 2, 0.78, 0.08, 5, 10, 1.55, 0, S.RBV, 0.1, 2, 'VALUE', '+RB GOLD', 8, 2],
  [2, 2, 1.02, 0.34, 1, 40, 1, 1, F.POT, 0, 6, 'POT', 'EVERY 5th', 8, 3, 10, 2],
  [3, 3, 0.30, 0.40, 5, 10, 1.55, 0, S.PFL, 0.004, 5, 'TICK', '+PASSIVE'],
  [3, 3, 0.58, 0.18, 1, 40, 1, 1, F.AURA, 0, 6, 'AURA', 'NEAR FILL', 12, 2],
  [3, 3, 0.80, 0.44, 3, 12, 1.7, 0, S.AUR, 0.25, 5, 'REACH', '+AURA', 13, 1],
  [3, 3, 1.04, 0.16, 5, 12, 1.55, 0, S.ATO, 0.012, 5, 'AUTO', '+AURA', 13, 1],
  [4, 4, 0.30, 0.14, 5, 8, 1.5, 0, S.TIM, 0.5, 3, 'TIME', '+START'],
  [4, 4, 0.55, 0.38, 3, 12, 1.7, 0, S.TEF, 0.12, 3, 'SLOW', '-DRAIN', 16, 1],
  [4, 4, 0.78, 0.10, 5, 10, 1.55, 0, S.TBN, 0.15, 3, 'BONUS', '+TIME $', 16, 2],
  [4, 4, 1.02, 0.36, 1, 40, 1, 1, F.BORROW, 0, 6, 'BORROW', '+TIME/RB', 16, 3],
  [5, 5, 0.32, 0.36, 3, 10, 1.7, 0, S.CHR, 0.25, 4, 'RANGE', '+CHAIN', 4, 1],
  [5, 5, 0.56, 0.12, 5, 12, 1.55, 0, S.OVR, 0.1, 4, 'OVER', 'OVERFLOW', 20, 1],
  [5, 5, 0.80, 0.40, 1, 45, 1, 1, F.CHAIN, 0, 6, 'CHAIN', 'CHAIN RB', 4, 1, 5, 2],
  [5, 5, 1.04, 0.18, 3, 15, 1.7, 0, S.SEC, 0.12, 4, 'ECHO', '+CHAIN', 22, 1],
  [2, 5, 1.22, 0.50, 1, 55, 1, 1, F.CASC, 0, 6, 'CASCADE', 'CHAIN $', 22, 1, 9, 2],
  [0, 1, 1.20, 0.48, 1, 60, 1, 1, F.NOVA, 0, 6, 'NOVA', 'OVER=BOOM', 0, 3, 5, 3],
  [2, 5, 1.42, 0.22, 1, 60, 1, 1, F.DBL, 0, 6, 'DOUBLE', 'EXTRA RB', 10, 3, 22, 1],
  [0, 3, 1.28, 0.08, 1, 55, 1, 1, F.AFTER, 0, 6, 'GHOST', 'LEAVE BEAM', 0, 3, 13, 1],
  [1, 5, 1.32, 0.52, 1, 60, 1, 1, F.CHROMA, 0, 6, 'CHROMA', 'CHAIN++', 4, 1, 22, 1],
  [4, 5, 1.22, 0.06, 1, 60, 1, 1, F.ETERN, 0, 6, 'ETERNAL', 'CHAIN TIME', 19, 1, 22, 1],
];
